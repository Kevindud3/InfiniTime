 ...
 */
Music::Music(Pinetime::Controllers::MusicService& musicService, Pinetime::Controllers::MotorController& motorController)
  : musicService(musicService), motorController(motorController) {
  lv_obj_t* label;
